...
import restful_urls, storagon_urls, junshare_urls
...
urlpatterns = patterns('servermain',
	...
	url(r'^buypremium/(\d+)/(\d+)/', 'payment_views.buyPremium', name='buyPremium'),
	url(r'^paygatecallback/(\w+)/', 'payment_views.paygateCallBack', name='paygateCallBack'),
