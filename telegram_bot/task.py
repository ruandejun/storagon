...
Chiết khấu: %s
%s
''' % (product_json['pict_url'], product_json['zk_final_price'], product_json['coupon_amount'], product_json['zk_final_price']-product_json['coupon_amount'], round(product_json['commission_price'], 2), product_json['taokouling'] )
    return html_show
