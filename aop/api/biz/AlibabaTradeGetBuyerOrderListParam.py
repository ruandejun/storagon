...
class AlibabaTradeGetBuyerOrderListParam(BaseApi):
    ...
    def get_required_params(self):
        return ['bizTypes', 'createEndTime', 'createStartTime', 'isHis', 'modifyEndTime', 'modifyStartTime', 'orderStatus', 'page', 'pageSize', 'refundStatus', 'sellerMemberId', 'sellerRateStatus', 'tradeType', 'productName', 'needBuyerAddressAndPhone', 'needMemoInfo']
