...
class MyAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        db_connection = connect(db=settings.MONGODB['NAME'], host=settings.MONGODB['HOST'], username=settings.MONGODB['USER'], password=settings.MONGODB['PASSWORD'], port=settings.MONGODB['PORT'], alias='default', tz_aware=settings.USE_TZ, authSource='admin')
