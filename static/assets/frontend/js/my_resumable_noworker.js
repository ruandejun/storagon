...
"use strict";
  ...
  var Resumable = function(opts){
    ...
    function ResumableFile(resumableObj, file){
      ...
      $.initEncryptor = function(hex_key){
          if(hex_key==null)hex_key=$.resumableObj.key;

          file_size = $.size;
		  chunk_size = $.getOpt('chunkSize');

		  console.log("Init AES Encryptor with key="+hex_key);
    ...
    function ResumableChunk(resumableObj, fileObj, offset, callback){
      ...
      $.sendEncryptedBlob = function(encrypted_blob) {
        ...
        //$.formData.append($.getOpt('fileParameterName'), encrypted_blob);
        //data.append($.getOpt('fileParameterName'), encrypted_blob);
      ...
      $.send = function(){
        ...
        if ($.getOpt('method') === 'octet') {
          ...
          //data.append($.getOpt('fileParameterName'), bytes);//should be comment
        ...
        reader.onload = function(e) {
          ...
          $.sendEncryptedBlob(encryptAES(e.target.result));
        };
