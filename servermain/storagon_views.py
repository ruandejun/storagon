...
class HomeView(generics.GenericAPIView):
	...
	def get(self, request, *args, **kwargs):
		mainURL = 'storagon_main/index.html'
		# print "Home View";
...
class DownloadView(generics.GenericAPIView):
	...
	def render_download_page(self, request, userFile):
		...
		# response = shortcuts.render(request,"storagon_main/dl.html",{
		response = shortcuts.render(request, "storagon_main/download.html", {
...
class DownloadToolView(generics.GenericAPIView):
	...
	def get(self, request, *args, **kwargs):
		# print "Home View";
		response = shortcuts.render(request, "storagon_main/download_tool.html", {
			'settings': settings
		})
...
class AffiliateToolView(generics.GenericAPIView):
	...
	def get(self, request, *args, **kwargs):
		# print "Home View";
		response = shortcuts.render(request, "storagon_main/affiliate_tool.html", {
			'settings': settings
		})
...
class PaymentSuccessView(generics.GenericAPIView):
	...
	def get(self, request, *args, **kwargs):
		# print "Home View";
		response = shortcuts.render(request, "storagon_main/payment_success.html", {
			'settings': settings
		})
...
class PaymentFailView(generics.GenericAPIView):
	...
	def get(self, request, *args, **kwargs):
		# print "Home View";
		response = shortcuts.render(request, "storagon_main/payment_fail.html", {
			'settings': settings
		})
