...
def signature_test():
    ...
    def decorator(view_func):
        ...
        def _wrapped_view(request, *args, **kwargs):
            ...
            correct_signature = hashlib.md5(settings.SECRET_KEY.encode('utf-8') + params.encode('utf-8')).hexdigest()
            if correct_signature != signature:
                # print params,'\n',params2
                correct_signature2 = hashlib.md5(settings.SECRET_KEY.encode('utf-8') + params2.encode('utf-8')).hexdigest()
